    ...
    return (
        <div className=' pt-40 mb-5 sm:p-16 text-black relative'>
            ...
            <ul className='flex items-center justify-around mt-16 flex-wrap '>
                <li className='flex flex-col items-center justify-around w-60  h-32 bg-color4 p-3 rounded-lg backdrop-blur-sm shadow-lg  mt-5'>
                ...
                <li className='flex items-center flex-col justify-around w-60 h-32 bg-color4 p-3 rounded-lg backdrop-blur-sm shadow-lg mt-5'>
