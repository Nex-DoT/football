...
const LineUp = ({data , color}) => {
    ...
    return (
        <div className='text-white flex items-center justify-center flex-col h-96 m-16 rounded-md bg-color2 shadow-lg'>
            <h1 className=' text-xl font-thin'>{data.played} Times played</h1>
