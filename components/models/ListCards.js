...
const ListCards = ({ data }) => {
  return (
    <div
      className="bg-color2 mt-20 relative flex flex-col items-center justify-center shadow-xl w-screen z-10 h-auto"
    >
      ...
      <div className="w-full flex flex-col items-center justify-between bg-white">
        <h1 className="pt-6 pb-6 text-3xl md:text-4xl font-thin italic">{data.text}</h1>
